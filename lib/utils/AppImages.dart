class AppImages {
  ...
  static const String kEnLogo = '${imageUrl}enLogo.png';

  // Todo

  static const String kHome = '${iconsUrl}home.svg';
  static const String kOrder = '${iconsUrl}order.svg';
  static const String kProduct = '${iconsUrl}product.svg';
  static const String kSetting = '${iconsUrl}setting.svg';
